...
using EmployeeService.Services.Other;
...
namespace EmployeeService
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            #region 
            builder.Services.AddSingleton<IAuthencateService, AuthenticateService>();
            #endregion
            ...
            builder.Services.AddSwaggerGen(c =>
            {
                ...
                {
                    Description = "Автоизация используя Bearer схему (Пример: 'Bearer 12345abcdef')",
                    Name = "Authorization",
